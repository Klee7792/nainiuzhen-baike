...
- #36  2026-09-15 02:15  v36: 启动进度两阶段真实化(准备数据不再卡 0%, 切片阶段显示帧数) / 冷启动计时 toast(X.XX 秒) / 右栏空态 10 条随机颜文字文案(仅从子页退回才换) / 详情弹窗 6 类块去背景(与手机小屏一致)；1.3.6(36)- #37  2026-09-15 02:45  v37: iOS 悬浮底栏主页/设置同宽(不再忽宽忽窄) / 选中指示器夹紧不溢出底栏 / 对齐 KernelSU 悬浮底栏观感(单选项 76dp 外边距 28dp)；1.3.7(37)
