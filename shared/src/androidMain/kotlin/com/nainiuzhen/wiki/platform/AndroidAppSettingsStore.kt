...
class AndroidAppSettingsStore(context: Context) : AppSettingsStore {
    ...
    override fun load(): AppState = AppState(
        ...
        navTransitionStyle = prefs.getInt(KEY_TRANSITION, 1),
        ...
        enableDim = prefs.getBoolean(KEY_DIM, true),
        ...
        dialogRecipeImageScale = prefs.getScaleFloat(KEY_DIALOG_RECIPE_IMAGE_SCALE, 5f),
        dialogFavHateImageScale = prefs.getScaleFloat(KEY_DIALOG_FAV_HATE_IMAGE_SCALE, 5f),
